                ...
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <div class="widget widget_about_us">
                            <h3>A PROPOS</h3>
                            <div class="widget_content">
                                <p>Suprail est une entreprise professionnel affili�e aux entreprises de transports ferroviaires, nous vous proposons une billeterie en ligne afin de r�server votre billet pour le voyage de votre choix.</p>
                            </div>
                        </div>
                    </div>
                    <!-- END / WIDGET -->
